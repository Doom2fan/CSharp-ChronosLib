...
namespace GZDoomLib.UDMF.Internal {
    ...
    internal class UDMFScanner {
        ...
        public List<UDMFToken> Skipped { get; protected set; } // Tokens that were skipped

        private UDMFToken lookAheadToken;

        public UDMFScanner () {
            lookAheadToken = null;
            Skipped = new List<UDMFToken> ();
        }
        ...
        public UDMFToken LookAhead () {
            ...
            if (lookAheadToken != null
                && lookAheadToken.Type != UDMFTokenType._UNDETERMINED_
                && lookAheadToken.Type != UDMFTokenType._NONE_)
                return lookAheadToken;

            var tok = new UDMFToken ();
        ...
        protected void ParseDecimal (StringBuilder sb, UDMFToken tok) {
